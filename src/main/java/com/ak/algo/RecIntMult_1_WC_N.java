...
public class RecIntMult_1_WC_N {
    public static void main(String[] args) {
        RecIntMult_1_WC_N mult  = new RecIntMult_1_WC_N();
        String num1 = "56";
        String num2 = "9999";
    ...
    private BigInteger intMult(BigInteger int1, BigInteger int2) {
        ...
        if ( ((int1_digitCount & 1) & (int2_digitCount) &  1) > 0) {
            System.out.println("either number is one" + int1 + "\t" + int2 );
            return int1.multiply(int2);
        }
        else {
            BigInteger[] int1_a = splitNumber(int1, int1_digitCount);
